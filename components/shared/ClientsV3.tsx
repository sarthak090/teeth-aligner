...
// Data-----------------
const topContent = ['Clear Aligners', 'Digital Smile Design', 'Clear Aligners', 'Digital Smile Design']
const bottomContent = ['Expert Care', 'Modern Technology', 'Custom Solutions', 'Expert Care', 'Modern Technology']
