...
const data = [
  {
    id: 1,
    reviewText:
      "AlignersFit transformed my smile journey! The aligners are comfortable and the results are amazing. Couldn't be happier with my new smile!",
    authorName: 'Emma Thompson',
    authorRole: 'Patient, 6 months treatment',
  },
  {
    id: 2,
    reviewText:
      'As a dental professional, I highly recommend AlignersFit. Their aligners are precise, comfortable, and deliver excellent results for my patients.',
    authorName: 'Dr. Michael Chen',
    authorRole: 'Orthodontist, Smile Dental Clinic',
  },
  {
    id: 3,
    reviewText:
      'The convenience of at-home treatment with AlignersFit has been life-changing. The aligners are virtually invisible and the customer service is exceptional!',
    authorName: 'Sarah Martinez',
    authorRole: 'Patient, 4 months treatment',
  },
  {
    id: 4,
    reviewText:
      'AlignersFit has revolutionized our practice. Their digital scanning technology and precise aligner manufacturing have improved our treatment outcomes significantly.',
    authorName: 'Dr. James Wilson',
    authorRole: 'Dental Director, Modern Dental Group',
  },
  {
    id: 5,
    reviewText:
      'I was skeptical about clear aligners, but AlignersFit proved me wrong. The results are better than I expected, and the process was so convenient!',
    authorName: 'David Park',
    authorRole: 'Patient, 8 months treatment',
  },
  {
    id: 6,
    reviewText:
      'The quality of AlignersFit aligners is outstanding. They provide excellent control over tooth movement and are comfortable for patients to wear.',
    authorName: 'Dr. Lisa Anderson',
    authorRole: 'Orthodontist, Premier Dental Care',
  },
  {
    id: 7,
    reviewText:
      'My confidence has soared since starting treatment with AlignersFit. The aligners are comfortable and the results are exactly what I wanted!',
    authorName: 'Rachel Kim',
    authorRole: 'Patient, 5 months treatment',
  },
  {
    id: 8,
    reviewText:
      'AlignersFit has been a game-changer for our practice. Their support team is responsive and the treatment planning software is intuitive.',
    authorName: 'Dr. Robert Taylor',
    authorRole: 'Dental Practice Owner',
  },
  {
    id: 9,
    reviewText:
      'The convenience of AlignersFit aligners has made my orthodontic journey stress-free. The results are amazing and the process was so simple!',
    authorName: 'Jessica Lee',
    authorRole: 'Patient, 7 months treatment',
  },
  {
    id: 10,
    reviewText:
      'We trust AlignersFit for our patients because of their commitment to quality and innovation. Their aligners consistently deliver excellent results.',
    authorName: 'Dr. Amanda White',
    authorRole: 'Orthodontist, Elite Dental Solutions',
  },
]
...
const TestimonialV9 = ({testimonials}: Props) => {
  return (
        ...
        <div className="mb-16 flex flex-col items-start justify-center gap-y-3 md:mb-20 md:flex-row md:items-center lg:justify-start">
          ...
          <div className="max-md:w-full md:max-w-[470px]">
            <TextAppearAnimation02>
              ...
              Our commitment to innovative orthodontic
solutions has earned us praise from both patients
            ...
            <SwiperSlide key={index}>
              <div className="swiper-slide">
                <div className="relative min-h-[370px] max-w-full border p-8 dark:border-dark 2xl:max-w-[360px]">
                  ...
                  <p className="mb-20 mt-10 text-lg leading-[1.6]">{item.description}</p>
                  <figcaption className="absolute bottom-8">
                    <h6 className="mb-[2px] text-[22px] leading-[1.2]">{item.name}</h6>
