...
import SplineToothProtection from './SplineToothProtection'
const HeroV5 = () => {
  return (
      ...
      <RevealWrapper className="flex flex-col items-center justify-center gap-y-8 pl-10 md:justify-between xl:flex-row">
        <div className="container max-sm:!-ml-[5%] lg:!ml-[10%] xl:!ml-[7%]">
          ...
          <h1 className="mt-6 hidden text-5xl font-medium md:block lg:text-6xl xl:text-7xl ">
           Flexible, Affordable, and Customized
          </h1>
          <div className="mt-6">
            ...
            <p className='text-gray-700 mt-4 '>Transform your smile with AlignersFit's custom clear aligners. Choose the payment plan that works best for you and start your journey to a confident smile today.
